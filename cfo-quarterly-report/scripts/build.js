...
ch.push(new Table({width:{size:CW,type:WidthType.DXA},columnWidths:[CW],rows:[new TableRow({children:[
  new TableCell({width:{size:CW,type:WidthType.DXA},shading:{fill:NAVY,type:ShadingType.CLEAR},borders:noB,
    margins:{top:200,bottom:160,left:240,right:240},children:[
      ...
      txt("Quarterly Financial Report",{bold:true,color:WHITE,size:40,spacing:{after:20}}),
...
// A
ch.push(h2("A.  Quarterly revenue & result \u2014 "+M.period_label));
...
ch.push(txt("Revenue trend \u2014 quarterly",{bold:true,size:18,spacing:{before:120,after:20}}));
ch.push(img(`${DIR}/revenue_trend.png`,620,Math.round(620*505/1360)));
...
// C
ch.push(h2("C.  Customers"));
ch.push(dataTable([3680,1900,1900,1880],["Client","Focal","T3M","Same mo. LY"],
  Cc.top_rows.map(r=>[{t:r.label,color:r.new?ORANGE:undefined},r.focal,r.t3m,{t:r.yoy,color:r.yoy_zero?GREY:undefined}])));
if(Cc.top_note) ch.push(txt(Cc.top_note,{size:16,color:GREEN,spacing:{before:80,after:80}}));
ch.push(img(`${DIR}/top10.png`,600,Math.round(600*520/1360)));
ch.push(txt("Revenue concentration",{bold:true,size:17,align:AlignmentType.CENTER,spacing:{before:40,after:0}}));
ch.push(img(`${DIR}/concentration.png`,300,Math.round(300*516/423)));
...
ch.push(txt("ARR snapshot (recurring book; quarter-exit MRR \u00D7 12):",{bold:true,size:17,spacing:{after:60}}));
...
const doc=new Document({
  ...
  sections:[{properties:{page:{size:{width:12240,height:15840},margin:{top:1080,right:1440,bottom:1080,left:1440}}},
    footers:{default:new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,
      ...
      children:[new TextRun({text:`${M.company} \u2014 Quarterly Financial Report \u2014 ${M.period_label}   \u2022   Confidential   \u2022   Page `,size:14,color:GREY}),
